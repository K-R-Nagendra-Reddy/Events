...
class Events extends Component {
  state = {
    ...
    registrationStatus: eventStatusConstants.initial,
  }

  changeRegistrationStatus = changeStatus => {
    this.setState({registrationStatus: changeStatus})
  }
    ...
    return (
      <div className="bg-container">
        <div className="events-container">
          ...
          <ul className="events-register">
            {initialEventsList.map(each => (
              <EventItem
                key={each.id}
                details={each}
        ...
        <div className="active-events-container">
          <ActiveEventRegistrationDetails
            ...
            constants={eventStatusConstants}
          />
        </div>
      </div>
    )
